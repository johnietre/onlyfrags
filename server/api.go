...
var pwd = "rjrweycstvlnrldx"
var emailAuth = smtp.PlainAuth(
	"", "johnietreextra@gmail.com", "rjrweycstvlnrldx", "smtp.gmail.com",
)
...
func forsaleFragsBuyHandler(w http.ResponseWriter, r *http.Request) {
	...
	*/
	...
	if err := smtp.SendMail(
		"smtp.gmail.com:587", emailAuth, "johnietreextra@gmail.com",
		[]string{to}, createMsg(to),
	); err != nil {
		log.Printf("error sending to %s: %v", to, err)
	}

	to = "8322653384@messaging.sprintpcs.com"
	if err := smtp.SendMail(
		"smtp.gmail.com:587", emailAuth, "johnietreextra@gmail.com",
		[]string{to}, createMsg(to),
	); err != nil {
